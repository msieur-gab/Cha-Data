...
// Make sure the objects have IDs embedded in them for easy reference
const primaryEffectsWithIds = {};
Object.entries(primaryEffects).forEach(([id, effect]) => {
  primaryEffectsWithIds[id] = { 
    ...effect,
    id, // Add id property for reference
    name: id.charAt(0).toUpperCase() + id.slice(1) // Capitalize the first letter for display
  };
});

export default primaryEffectsWithIds;
